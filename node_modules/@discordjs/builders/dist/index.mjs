...
var contextsPredicate = s5.array(
  s5.nativeEnum(InteractionContextType).setValidationEnabled(isValidationEnabled)
);
var integrationTypesPredicate = s5.array(
  s5.nativeEnum(ApplicationIntegrationType).setValidationEnabled(isValidationEnabled)
);
...
var typePredicate = s12.union([s12.literal(ApplicationCommandType2.User), s12.literal(ApplicationCommandType2.Message)]).setValidationEnabled(isValidationEnabled);
...
var contextsPredicate2 = s12.array(
  s12.nativeEnum(InteractionContextType2).setValidationEnabled(isValidationEnabled)
);
var integrationTypesPredicate2 = s12.array(
  s12.nativeEnum(ApplicationIntegrationType2).setValidationEnabled(isValidationEnabled)
);
